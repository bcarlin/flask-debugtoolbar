...
latex_documents = [
  ('index', 'Flask-DebugToolbar.tex', 'Flask-DebugToolbar Documentation',
   'Matt Good', 'manual'),
]
...
man_pages = [
    ('index', 'flask-debugtoolbar', 'Flask-DebugToolbar Documentation',
     ['Matt Good'], 1)
]
...
texinfo_documents = [
  ('index', 'Flask-DebugToolbar', 'Flask-DebugToolbar Documentation',
   'Matt Good', 'Flask-DebugToolbar', 'One line description of project.',
   'Miscellaneous'),
]
